...
# This includes the input and output file names

HOST = "localhost"
PORT = 9999
ADDRESS_TUPLE = (HOST, PORT)
INPUT_FILE_NAME = "Dd5e_monsters.csv"
...
def prepare_message_from_row(row):
    ...
    Name, Size, Race_alignment, HitPoints, Armor, Speed, Challenge_rating = row
    # use an fstring to create a message from our data
    # notice the f before the opening quote for our string?
    fstring_message = f"[{Name}, {Size}, {Race_alignment}, {HitPoints}, {Armor}, {Speed}, {Challenge_rating}]"
...
def stream_row(input_file_name, address_tuple):
    ...
    with open(input_file_name, "r") as input_file:
        ...
        with open(OUTPUT_FILE_NAME, "w", newline="") as output_file:
            ...
            writer.writerow(["Name", "Size", "Race_alignment", "HitPoints", "Armor", "Speed", "Challenge_rating"])
